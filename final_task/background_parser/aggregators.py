...
class FilesStatisticAggregator:
    """
    Вычисляет и агрегирует статистику по всем файлам.
    """
    ...
    def merge_general_stats(self, general_stat):
    ...
    def merge_word_frequency_stats(self, word_frequency_ru, word_frequency_en):
...
class FolderStatisticAggregator:
    ...
    def add_files_statistic(self, files_stats):
